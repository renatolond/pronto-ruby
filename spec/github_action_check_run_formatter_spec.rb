...
RSpec.describe Pronto::Formatter::GithubActionCheckRunFormatter do
  ...
  context "when the runner is rubocop" do
    it "posts a check run with annotations" do
      ...
      stub_request(:post, check_runs_url).to_return(
      ...
      expect(
        a_request(:post, "https://api.github.com/repos/Codertocat/Hello-World/check-runs").with do |request|
          ...
          expect(data["name"]).to eq "rubocop"
          expect(data.dig("output", "summary")).to match(/There are 13 issues/)
          expect(data.dig("output", "annotations").size).to eq 13
          ...
          expect(data.dig("output", "annotations")).to eq([
                                                            ...
                                                            { "annotation_level" => "warning",
                                                              "end_line" => 3,
                                                              "message" => "Naming/ClassAndModuleCamelCase: Use CamelCase for classes and modules. (https://rubystyle.guide#camelcase-classes)",
                                                              "path" => "main.rb",
                                                              "start_line" => 3,
                                                              "title" => "rubocop" },
                                                            { "annotation_level" => "warning",
                                                              "end_line" => 4,
                                                              "message" => "Layout/IndentationWidth: Use 2 (not 4) spaces for indentation. (https://rubystyle.guide#spaces-indentation)",
                                                              "path" => "main.rb",
                                                              "start_line" => 4,
                                                              "title" => "rubocop" },
                                                            { "annotation_level" => "warning",
                                                              "end_line" => 4,
                                                              "message" => "Style/DocumentationMethod: Missing method documentation comment.",
                                                              "path" => "main.rb",
                                                              "start_line" => 4,
                                                              "title" => "rubocop" },
                                                            { "annotation_level" => "warning",
                                                              ...
                                                              "message" => "Naming/MethodName: Use snake_case for method names. (https://rubystyle.guide#snake-case-symbols-methods-vars)",
                                                              "path" => "main.rb",
                                                              "start_line" => 4,
                                                              "title" => "rubocop" },
                                                            { "annotation_level" => "warning",
                                                              "end_line" => 4,
                                                              "message" => "Style/DefWithParentheses: Omit the parentheses in defs when the method doesn't accept any arguments. (https://rubystyle.guide#method-parens)",
                                                              "path" => "main.rb",
                                                              "start_line" => 4,
                                                              "title" => "rubocop" },
                                                            { "annotation_level" => "warning",
  ...
  # yamllint is disabled because it does not work with current pronto versions
  ...
  # pronto-poper is disabled because it doesn't seem to work anymore with pronto
